"""``AliasChunkProvider`` — Posture B: synthesize ONE chunk with a single
...
class AliasChunkProvider(SyncProvider):
    """Synthesize a single chunk via the Alias internal API."""
