<x-layout title="Dashboard" description="Overview and connection details for any ElevenLabs-compatible app.">
    ...
    <div class="mt-8 rounded-xl border border-zinc-800 bg-zinc-900/50">
        <div class="border-b border-zinc-800 px-5 py-4">
            ...
            <p class="mt-1 text-sm text-zinc-400">Bespoken speaks the ElevenLabs v1 API, so any ElevenLabs-compatible app works — including the Bespoken Craft CMS plugin. Paste these into its API settings.</p>
        </div>
