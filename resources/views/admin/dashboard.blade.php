<x-layout title="Dashboard" description="Overview and connection details for the Bespoken plugin.">
    ...
    <div class="mt-8 rounded-xl border border-zinc-800 bg-zinc-900/50">
        <div class="border-b border-zinc-800 px-5 py-4">
            <h2 class="font-semibold">Connect Bespoken</h2>
            <p class="mt-1 text-sm text-zinc-400">Paste these into the plugin's ElevenLabs-compatible settings.</p>
        </div>
