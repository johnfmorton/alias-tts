...
{{-- One Chatterbox knob as slider + number box + reset (↺), matching the Hugging
...
<div {{ $attributes->merge(['class' => 'tuning-knob flex min-w-[11rem] flex-col gap-1']) }} data-knob="{{ $knob }}">
