...
class GenerateProjectChunksJob implements ShouldQueue
{
    ...
    public function handle(ProjectService $service): void
    {
        ...
        foreach ($chunkIds as $i => $chunkId) {
            // Fresh row each pass: the flag is set from another process, and the
            // row itself vanishes if the project is deleted mid-run.
        ...
        $this->finish($job->fresh() ?? $job, ProjectJobStatus::Completed);
    }
